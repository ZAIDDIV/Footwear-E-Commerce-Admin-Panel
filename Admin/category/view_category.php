...
if (isset($_POST['clear_all'])) {
    ...
    if (mysqli_query($conn, $deleteQuery)) {
        echo "<script>alert('All categories have been deleted!'); window.location.href = 'category.php';</script>";
    } else {
        ...
        <div class="card-body">
            <table class="table table-hover table-bordered text-center">
                ...
                <tbody>
                    ...
                    <!-- Edit Modal -->
                    <div class="modal fade" id="editModal<?= $row['cat_id'] ?>" tabindex="-1" aria-labelledby="editModalLabel<?= $row['cat_id'] ?>" aria-hidden="true">
